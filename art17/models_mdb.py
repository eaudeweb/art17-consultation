...
class DataSpeciesCheckList(Base):
    ...
    hd_name = Column('HD_name', String(120))
    species_name = Column(String(120))
    annex_ii = Column('annex_II', String(510))
    annex_iv = Column('annex_IV', String(510))
    annex_v = Column('annex_V', String(510))
    member_state = Column(String(510), primary_key=True, nullable=False)
    bio_region = Column(String(510), primary_key=True, nullable=False)
    presence = Column('Presence', String(20), nullable=False)
