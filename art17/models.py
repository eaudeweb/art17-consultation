...
class DataHabitattypeRegion(Base):
    ...
    complementary_favourable_range_x = Column(Numeric, nullable=False)
    complementary_favourable_range_method = Column(Text)
    range_reasons_for_change_a = Column(Numeric, nullable=False)
    range_reasons_for_change_b = Column(Numeric, nullable=False)
    range_reasons_for_change_c = Column(Numeric, nullable=False)
    ...
    coverage_trend_long_magnitude_ci = Column(Numeric)
    ...
    complementary_favourable_area_x = Column(Numeric, nullable=False)
