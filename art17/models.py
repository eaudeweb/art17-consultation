...
class DataHabitatsCheckList(Base):
    ...
    natura_2000_code = Column(String(510), primary_key=True, index=True)
    hd_name = Column(String(510))
    valid_name = Column(String(510))
    ms = Column(String(510), primary_key=True)
    bio_region = Column(String(510), primary_key=True)
    presence = Column(String(510))
...
class DataNote(Base):
    ...
    entity_table_name = Column(String(510))
...
class DataSpeciesCheckList(Base):
    ...
    natura_2000_code = Column(String(16), primary_key=True, index=True)
    ...
    member_state = Column(String(510), primary_key=True)
    bio_region = Column(String(510), primary_key=True)
