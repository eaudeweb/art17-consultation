...
class DataHabitattypeRegion(Base):
    ...
    range_trend_magnitude_min = Column('range_trend_mag_min', Text)
    range_trend_magnitude_max = Column('range_trend_mag_max', Text)
    range_trend_long_period = Column(String(18))
    range_trend_long = Column(String(510))
    range_trend_long_magnitude_min = Column('range_trend_long_mag_min', Text)
    range_trend_long_magnitude_max = Column('range_trend_long_mag_max', Text)
    complementary_favourable_range = Column('compl_favourable_range', Text)
    ...
    coverage_trend_magnitude_min = Column('coverage_trend_mag_min', Text)
    coverage_trend_magnitude_max = Column('coverage_trend_mag_max', Text)
    ...
    coverage_trend_long_magnitude_min = Column('coverage_trend_long_mag_min', Text)
    coverage_trend_long_magnitude_max = Column('coverage_trend_long_mag_max', Text)
    coverage_trend_long_magnitude_ci = Column('coverage_trend_long_mag_ci', Numeric)
    coverage_trend_long_method = Column(String(510))
    complementary_favourable_area = Column('comp_favourable_area', Text)
