...
SEQUENCE_MAP = {
    ...
    'ibb': [
        ('R2378', 'data_gmeasures'),
        ('R2379', 'data_greintrod_of_spec'),
        ('R2380', 'data_greport'),
        ('R2381', 'data_habitats'),
        ('R2382', 'data_habitats_check_list'),
        ('R2383', 'data_habitattype_reg'),
        ('R2384', 'data_htypical_species'),
        ('R2385', 'data_measures'),
        ('R2386', 'data_notes'),
        ('R2387', 'data_pressures_threats'),
        ('R2388', 'data_pressures_threats_pol'),
        ('R2389', 'data_species'),
        ('R2390', 'data_species_check_list'),
        ('R2391', 'data_species_regions'),
        ('R2392', 'lu_art17_habitats_check_list'),
        ('R2393', 'lu_art17_species_check_list'),
        ('R2394', 'lu_assessments'),
        ('R2395', 'lu_biogeoreg'),
        ('R2396', 'lu_countries_regions'),
        ('R2397', 'lu_country_code'),
        ('R2398', 'lu_favourable_range_operator'),
        ('R2399', 'lu_habitattype_codes'),
        ('R2400', 'lu_hd_species'),
        ('R2401', 'lu_measures'),
        ('R2402', 'lu_methods_pressures'),
        ('R2403', 'lu_methods_threats'),
        ('R2404', 'lu_methods_used'),
        ('R2405', 'lu_pollution'),
        ('R2406', 'lu_population_number'),
        ('R2407', 'lu_population_units_restricted'),
        ('R2408', 'lu_presence'),
        ('R2409', 'lu_quality'),
        ('R2410', 'lu_ranking'),
        ('R2411', 'lu_reintroduction'),
        ('R2412', 'lu_threats'),
        ('R2413', 'lu_trends'),
        ('R2414', 'lu_trends_conclusion'),
        ('R2415', 'merge_diff'),
        ('R2416', 'sys_dummy'),
        ('R2417', 'sys_import'),
        ('R2418', 'sys_info_be'),
        ...
        ('R2420', 'sys_user'),
        ('R2421', 'sys_yesno'),
        ('R2422', 'validate_fields'),
        ('R2423', 'validation_result'),
        ('R2424', 'art17_habitats_range'),
        ('R2425', 'art17_habitats_distribution'),
        ('R2426', 'art17_species_distribution'),
        ('R2427', 'art17_species_range'),
    ]
}
